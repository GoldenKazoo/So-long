...
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_valid_road7.ber
echo "==================================================================="
./so_long map/maps_err/no_valid_road8.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_valid_road8.ber
echo "==================================================================="
./so_long map/maps_err/no_valid_road9.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_valid_road9.ber
echo "==================================================================="
./so_long map/maps_err/no_valid_road10.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_valid_road10.ber
echo "==================================================================="
./so_long map/maps_err/no_valid_road11.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_valid_road11.ber
echo "==================================================================="
./so_long map/maps_err/no_valid_road12.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_valid_road12.ber
echo "==================================================================="
./so_long map/maps_err/no_valid_road14.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_valid_road14.ber
echo "==================================================================="
./so_long map/maps_err/no_valid_road15.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_valid_road15.ber
echo "==================================================================="



./so_long map/maps_err/no_walls.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_walls.ber
echo "==================================================================="
./so_long map/maps_err/no_walls1.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_walls1.ber
echo "==================================================================="
./so_long map/maps_err/no_walls2.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_walls2.ber
echo "==================================================================="
./so_long map/maps_err/no_walls3.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_walls3.ber
echo "==================================================================="
./so_long map/maps_err/no_walls4.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_walls4.ber
echo "==================================================================="
./so_long map/maps_err/no_walls5.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_walls5.ber
echo "==================================================================="
./so_long map/maps_err/no_walls6.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_walls6.ber
echo "==================================================================="
./so_long map/maps_err/no_walls7.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_walls7.ber
echo "==================================================================="
./so_long map/maps_err/no_walls8.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_walls8.ber
echo "==================================================================="
./so_long map/maps_err/no_walls9.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/no_walls9.ber
echo "==================================================================="

./so_long map/maps_err/wrong_chars.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/wrong_chars.ber
echo "==================================================================="
./so_long map/maps_err/wrong_chars1.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/wrong_chars1.ber
echo "==================================================================="
./so_long map/maps_err/wrong_chars2.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/wrong_chars2.ber
echo "==================================================================="
./so_long map/maps_err/wrong_chars3.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/wrong_chars3.ber
echo "==================================================================="
./so_long map/maps_err/wrong_chars4.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/wrong_chars4.ber
echo "==================================================================="
./so_long map/maps_err/wrong_chars5.ber
valgrind --leak-check=full --show-leak-kinds=all ./so_long map/maps_err/wrong_chars5.ber
echo "==================================================================="
